...
let services, Usuario, Persona, Empresa, Representante;
...
router.post('/representante/add', (req, res) => {
    Controller.addRepresentante(req.body, Usuario, Representante)
        .then(() => {
            req.session.success = "Representante registrado con éxito!";
